...
ENTITY 	projeto6 IS
	...
	entrada3 : IN IEEE.NUMERIC_STD.unsigned(3 DOWNTO 0);
	entrada4 : IN IEEE.NUMERIC_STD.unsigned(3 DOWNTO 0);
	min_val : OUT IEEE.NUMERIC_STD.unsigned(3 DOWNTO 0);
	max_val : OUT IEEE.NUMERIC_STD.unsigned(3 DOWNTO 0)
	);
END projeto6;
...
ww_entrada3 <= IEEE.STD_LOGIC_1164.STD_LOGIC_VECTOR(entrada3);
ww_entrada4 <= IEEE.STD_LOGIC_1164.STD_LOGIC_VECTOR(entrada4);
min_val <= IEEE.NUMERIC_STD.UNSIGNED(ww_min_val);
max_val <= IEEE.NUMERIC_STD.UNSIGNED(ww_max_val);
ww_devoe <= devoe;
ww_devclrn <= devclrn;
ww_devpor <= devpor;
