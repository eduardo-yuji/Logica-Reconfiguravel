...
-- Design Ports Information
-- sel[1]	=>  Location: PIN_F15,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \Mux0~0_combout\ = (\sel[0]~input_o\ & ((\x[4]~input_o\))) # (!\sel[0]~input_o\ & (\x[0]~input_o\))
...
-- Equation(s):
-- \Mux1~0_combout\ = (\sel[0]~input_o\ & ((\x[5]~input_o\))) # (!\sel[0]~input_o\ & (\x[1]~input_o\))
...
-- Equation(s):
-- \Mux2~0_combout\ = (\sel[0]~input_o\ & ((\x[6]~input_o\))) # (!\sel[0]~input_o\ & (\x[2]~input_o\))
...
-- Equation(s):
-- \Mux3~0_combout\ = (\sel[0]~input_o\ & ((\x[7]~input_o\))) # (!\sel[0]~input_o\ & (\x[3]~input_o\))
